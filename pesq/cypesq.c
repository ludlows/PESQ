...
/* BEGIN: Cython Metadata
{
    "distutils": {
        "depends": [
            "/home/miao/miniconda3/lib/python3.6/site-packages/numpy/core/include/numpy/arrayobject.h",
            "/home/miao/miniconda3/lib/python3.6/site-packages/numpy/core/include/numpy/ufuncobject.h",
            "pesq/pesq.h",
            "pesq/pesqio.h",
            "pesq/pesqmain.h"
        ],
        "include_dirs": [
            "pesq",
            "/home/miao/miniconda3/lib/python3.6/site-packages/numpy/core/include"
        ],
        "language": "C",
        "name": "cypesq",
        "sources": [
...
#define __PYX_HAVE__cypesq
#define __PYX_HAVE_API__cypesq
/* Early includes */
#include <string.h>
#include <stdio.h>
...
/* Module declarations from 'cypesq' */
static PyObject *__pyx_f_6cypesq_cypesq(long, PyArrayObject *, PyArrayObject *, int, int __pyx_skip_dispatch); /*proto*/
static __Pyx_TypeInfo __Pyx_TypeInfo_float = { "float", NULL, sizeof(float), { 0 }, 0, 'R', 0, 0 };
#define __Pyx_MODULE_NAME "cypesq"
extern int __pyx_module_is_main_cypesq;
int __pyx_module_is_main_cypesq = 0;

/* Implementation of 'cypesq' */
...
static const char __pyx_k_deg_data[] = "deg_data";
...
static PyObject *__pyx_n_s_deg_data;
...
static PyObject *__pyx_pf_6cypesq_cypesq(CYTHON_UNUSED PyObject *__pyx_self, long __pyx_v_sample_rate, PyArrayObject *__pyx_v_ref_data, PyArrayObject *__pyx_v_deg_data, int __pyx_v_mode); /* proto */
...
static PyObject *__pyx_pw_6cypesq_1cypesq(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyObject *__pyx_f_6cypesq_cypesq(long __pyx_v_sample_rate, PyArrayObject *__pyx_v_ref_data, PyArrayObject *__pyx_v_deg_data, int __pyx_v_mode, CYTHON_UNUSED int __pyx_skip_dispatch) {
  long __pyx_v_error_flag;
  char *__pyx_v_error_type;
  long __pyx_v_length_ref;
  long __pyx_v_length_deg;
  SIGNAL_INFO __pyx_v_ref_info;
  SIGNAL_INFO __pyx_v_deg_info;
  char *__pyx_v_ref_name;
  char *__pyx_v_deg_name;
  int __pyx_v_i;
  ERROR_INFO __pyx_v_err_info;
  __Pyx_LocalBuf_ND __pyx_pybuffernd_deg_data;
  __Pyx_Buffer __pyx_pybuffer_deg_data;
  __Pyx_LocalBuf_ND __pyx_pybuffernd_ref_data;
  __Pyx_Buffer __pyx_pybuffer_ref_data;
  ...
  __Pyx_RefNannySetupContext("cypesq", 0);
  __pyx_pybuffer_ref_data.pybuffer.buf = NULL;
  __pyx_pybuffer_ref_data.refcount = 0;
  __pyx_pybuffernd_ref_data.data = NULL;
  __pyx_pybuffernd_ref_data.rcbuffer = &__pyx_pybuffer_ref_data;
  __pyx_pybuffer_deg_data.pybuffer.buf = NULL;
  __pyx_pybuffer_deg_data.refcount = 0;
  __pyx_pybuffernd_deg_data.data = NULL;
  __pyx_pybuffernd_deg_data.rcbuffer = &__pyx_pybuffer_deg_data;
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_ref_data.rcbuffer->pybuffer, (PyObject*)__pyx_v_ref_data, &__Pyx_TypeInfo_float, PyBUF_FORMAT| PyBUF_C_CONTIGUOUS, 1, 0, __pyx_stack) == -1)) __PYX_ERR(0, 53, __pyx_L1_error)
  }
  __pyx_pybuffernd_ref_data.diminfo[0].strides = __pyx_pybuffernd_ref_data.rcbuffer->pybuffer.strides[0]; __pyx_pybuffernd_ref_data.diminfo[0].shape = __pyx_pybuffernd_ref_data.rcbuffer->pybuffer.shape[0];
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_deg_data.rcbuffer->pybuffer, (PyObject*)__pyx_v_deg_data, &__Pyx_TypeInfo_float, PyBUF_FORMAT| PyBUF_C_CONTIGUOUS, 1, 0, __pyx_stack) == -1)) __PYX_ERR(0, 53, __pyx_L1_error)
  }
  __pyx_pybuffernd_deg_data.diminfo[0].strides = __pyx_pybuffernd_deg_data.rcbuffer->pybuffer.strides[0]; __pyx_pybuffernd_deg_data.diminfo[0].shape = __pyx_pybuffernd_deg_data.rcbuffer->pybuffer.shape[0];
 ...
 *     if error_flag != 0:
 */
  __pyx_v_error_type = ((char *)"unknown");
 ...
 *         return -1
 */
  select_rate(__pyx_v_sample_rate, (&__pyx_v_error_flag), (&__pyx_v_error_type));
 ...
 * 
 */
  __pyx_v_length_ref = (__pyx_v_ref_data->dimensions[0]);
 ...
 */
  __pyx_v_length_deg = (__pyx_v_deg_data->dimensions[0]);
 ...
 * 
 */
  __pyx_v_ref_name = ((char *)"reference-signal");
 ...
 *     cdef int i = 0;
 */
  __pyx_v_deg_name = ((char *)"degrade-signal");
 ...
 */
  while (1) {
    __pyx_t_1 = ((__pyx_v_ref_name[__pyx_v_i]) != 0);
    if (!__pyx_t_1) break;
 ...
 *         i += 1
 */
    (__pyx_v_ref_info.path_name[__pyx_v_i]) = (__pyx_v_ref_name[__pyx_v_i]);
 ...
 * 
 */
    (__pyx_v_ref_info.file_name[__pyx_v_i]) = (__pyx_v_ref_name[__pyx_v_i]);
 ...
 * 
 */
  (__pyx_v_ref_info.path_name[__pyx_v_i]) = 0;
 ...
 *     i = 0
 */
  (__pyx_v_ref_info.file_name[__pyx_v_i]) = 0;
 ...
 */
  while (1) {
    __pyx_t_1 = ((__pyx_v_deg_name[__pyx_v_i]) != 0);
    if (!__pyx_t_1) break;
 ...
 *         i += 1
 */
    (__pyx_v_deg_info.path_name[__pyx_v_i]) = (__pyx_v_deg_name[__pyx_v_i]);
 ...
 * 
 */
    (__pyx_v_deg_info.file_name[__pyx_v_i]) = (__pyx_v_deg_name[__pyx_v_i]);
 ...
 * 
 */
  (__pyx_v_deg_info.path_name[__pyx_v_i]) = 0;
 ...
 * 
 */
  (__pyx_v_deg_info.file_name[__pyx_v_i]) = 0;
 ...
 */
  __pyx_v_ref_info.Nsamples = __pyx_v_length_ref;
 ...
 * 
 */
  __pyx_v_ref_info.input_filter = 1;
 ...
 */
  ...
  __pyx_t_3 = -1;
  if (__pyx_t_2 < 0) {
    __pyx_t_2 += __pyx_pybuffernd_ref_data.diminfo[0].shape;
    if (unlikely(__pyx_t_2 < 0)) __pyx_t_3 = 0;
  } else if (unlikely(__pyx_t_2 >= __pyx_pybuffernd_ref_data.diminfo[0].shape)) __pyx_t_3 = 0;
  if (unlikely(__pyx_t_3 != -1)) {
    __Pyx_RaiseBufferIndexError(__pyx_t_3);
    __PYX_ERR(0, 93, __pyx_L1_error)
  }
  __pyx_v_ref_info.data = (&(*__Pyx_BufPtrCContig1d(float *, __pyx_pybuffernd_ref_data.rcbuffer->pybuffer.buf, __pyx_t_2, __pyx_pybuffernd_ref_data.diminfo[0].strides)));
 ...
 */
  __pyx_v_deg_info.Nsamples = __pyx_v_length_deg;
 ...
 * 
 */
  __pyx_v_deg_info.input_filter = 1;
 ...
 */
  ...
  __pyx_t_3 = -1;
  if (__pyx_t_4 < 0) {
    __pyx_t_4 += __pyx_pybuffernd_deg_data.diminfo[0].shape;
    if (unlikely(__pyx_t_4 < 0)) __pyx_t_3 = 0;
  } else if (unlikely(__pyx_t_4 >= __pyx_pybuffernd_deg_data.diminfo[0].shape)) __pyx_t_3 = 0;
  if (unlikely(__pyx_t_3 != -1)) {
    __Pyx_RaiseBufferIndexError(__pyx_t_3);
    __PYX_ERR(0, 99, __pyx_L1_error)
  }
  __pyx_v_deg_info.data = (&(*__Pyx_BufPtrCContig1d(float *, __pyx_pybuffernd_deg_data.rcbuffer->pybuffer.buf, __pyx_t_4, __pyx_pybuffernd_deg_data.diminfo[0].strides)));
 ...
 */
    __pyx_v_ref_info.input_filter = 2;
 ...
 * 
 */
    __pyx_v_deg_info.input_filter = 2;
 ...
 *         return -1
 */
  pesq_measure((&__pyx_v_ref_info), (&__pyx_v_deg_info), (&__pyx_v_err_info), (&__pyx_v_error_flag), (&__pyx_v_error_type));
 ...
 */
  __Pyx_XDECREF(__pyx_r);
  __pyx_t_5 = PyFloat_FromDouble(__pyx_v_err_info.mapped_mos); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 112, __pyx_L1_error)
 ...
 */
  ...
  { PyObject *__pyx_type, *__pyx_value, *__pyx_tb;
    ...
    __Pyx_SafeReleaseBuffer(&__pyx_pybuffernd_deg_data.rcbuffer->pybuffer);
    __Pyx_SafeReleaseBuffer(&__pyx_pybuffernd_ref_data.rcbuffer->pybuffer);
  __Pyx_ErrRestore(__pyx_type, __pyx_value, __pyx_tb);}
  __Pyx_AddTraceback("cypesq.cypesq", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = 0;
  goto __pyx_L2;
  __pyx_L0:;
  __Pyx_SafeReleaseBuffer(&__pyx_pybuffernd_deg_data.rcbuffer->pybuffer);
...
/* Python wrapper */
static PyObject *__pyx_pw_6cypesq_1cypesq(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyObject *__pyx_pw_6cypesq_1cypesq(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  long __pyx_v_sample_rate;
  PyArrayObject *__pyx_v_ref_data = 0;
  PyArrayObject *__pyx_v_deg_data = 0;
  int __pyx_v_mode;
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("cypesq (wrapper)", 0);
  {
    static PyObject **__pyx_pyargnames[] = {&__pyx_n_s_sample_rate,&__pyx_n_s_ref_data,&__pyx_n_s_deg_data,&__pyx_n_s_mode,0};
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        CYTHON_FALLTHROUGH;
        case  1:
        if (likely((values[1] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_ref_data)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("cypesq", 1, 4, 4, 1); __PYX_ERR(0, 53, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  2:
        if (likely((values[2] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_deg_data)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("cypesq", 1, 4, 4, 2); __PYX_ERR(0, 53, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  3:
        if (likely((values[3] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_mode)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("cypesq", 1, 4, 4, 3); __PYX_ERR(0, 53, __pyx_L3_error)
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "cypesq") < 0)) __PYX_ERR(0, 53, __pyx_L3_error)
      }
    ...
    __pyx_v_sample_rate = __Pyx_PyInt_As_long(values[0]); if (unlikely((__pyx_v_sample_rate == (long)-1) && PyErr_Occurred())) __PYX_ERR(0, 53, __pyx_L3_error)
    __pyx_v_ref_data = ((PyArrayObject *)values[1]);
    __pyx_v_deg_data = ((PyArrayObject *)values[2]);
    __pyx_v_mode = __Pyx_PyInt_As_int(values[3]); if (unlikely((__pyx_v_mode == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 53, __pyx_L3_error)
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("cypesq", 1, 4, 4, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 53, __pyx_L3_error)
  __pyx_L3_error:;
  __Pyx_AddTraceback("cypesq.cypesq", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_ref_data), __pyx_ptype_5numpy_ndarray, 1, "ref_data", 0))) __PYX_ERR(0, 53, __pyx_L1_error)
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_deg_data), __pyx_ptype_5numpy_ndarray, 1, "deg_data", 0))) __PYX_ERR(0, 53, __pyx_L1_error)
  __pyx_r = __pyx_pf_6cypesq_cypesq(__pyx_self, __pyx_v_sample_rate, __pyx_v_ref_data, __pyx_v_deg_data, __pyx_v_mode);
...
static PyObject *__pyx_pf_6cypesq_cypesq(CYTHON_UNUSED PyObject *__pyx_self, long __pyx_v_sample_rate, PyArrayObject *__pyx_v_ref_data, PyArrayObject *__pyx_v_deg_data, int __pyx_v_mode) {
  __Pyx_LocalBuf_ND __pyx_pybuffernd_deg_data;
  __Pyx_Buffer __pyx_pybuffer_deg_data;
  __Pyx_LocalBuf_ND __pyx_pybuffernd_ref_data;
  __Pyx_Buffer __pyx_pybuffer_ref_data;
  ...
  __pyx_pybuffernd_deg_data.diminfo[0].strides = __pyx_pybuffernd_deg_data.rcbuffer->pybuffer.strides[0]; __pyx_pybuffernd_deg_data.diminfo[0].shape = __pyx_pybuffernd_deg_data.rcbuffer->pybuffer.shape[0];
  __Pyx_XDECREF(__pyx_r);
  __pyx_t_1 = __pyx_f_6cypesq_cypesq(__pyx_v_sample_rate, __pyx_v_ref_data, __pyx_v_deg_data, __pyx_v_mode, 0); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 53, __pyx_L1_error)
...
static PyMethodDef __pyx_methods[] = {
  {"cypesq", (PyCFunction)(void*)(PyCFunctionWithKeywords)__pyx_pw_6cypesq_1cypesq, METH_VARARGS|METH_KEYWORDS, 0},
  {0, 0, 0, 0}
};
...
static int __pyx_pymod_exec_cypesq(PyObject* module); /*proto*/
static PyModuleDef_Slot __pyx_moduledef_slots[] = {
  {Py_mod_create, (void*)__pyx_pymod_create},
  {Py_mod_exec, (void*)__pyx_pymod_exec_cypesq},
  {0, NULL}
};
#endif
...
static __Pyx_StringTabEntry __pyx_string_tab[] = {
  ...
  {&__pyx_n_s_deg_data, __pyx_k_deg_data, sizeof(__pyx_k_deg_data), 0, 0, 1, 1},
...
#if PY_MAJOR_VERSION < 3
__Pyx_PyMODINIT_FUNC initcypesq(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC initcypesq(void)
#else
__Pyx_PyMODINIT_FUNC PyInit_cypesq(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC PyInit_cypesq(void)
#if CYTHON_PEP489_MULTI_PHASE_INIT
{
...
static CYTHON_SMALL_CODE int __pyx_pymod_exec_cypesq(PyObject *__pyx_pyinit_module)
#endif
#endif
{
  PyObject *__pyx_t_1 = NULL;
  ...
  if (__pyx_m) {
    ...
    PyErr_SetString(PyExc_RuntimeError, "Module 'cypesq' has already been imported. Re-initialisation is not supported.");
    return -1;
  }
...
if (!__Pyx_RefNanny) {
...
#endif
  __Pyx_RefNannySetupContext("__Pyx_PyMODINIT_FUNC PyInit_cypesq(void)", 0);
  ...
  #else
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4("cypesq", __pyx_methods, 0, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
  ...
  #endif
  if (__pyx_module_is_main_cypesq) {
    if (PyObject_SetAttr(__pyx_m, __pyx_n_s_name, __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "cypesq")) {
      if (unlikely(PyDict_SetItemString(modules, "cypesq", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init cypesq", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_CLEAR(__pyx_m);
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init cypesq");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
